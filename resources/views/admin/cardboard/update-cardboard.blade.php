    ...
    <div class="">
        <div class="page-title px-sm-4">
            <div class="title_left mb-sm-4 w-100">
                <h3> Update Cardboard Product</h3>
            </div>
        </div>
        <div class="clearfix"></div>
        ...
        <form class="form px-sm-4" method="post" action="{{ url('update-cardboard'.'/'. $edit_prod_item->id).'/' }}" enctype="multipart/form-data">
                        ...
                        <label for="fileuploadbasic" class="col-form-label">Gallery</label>
                            ...
                            @if ( !empty($images) )
                                @foreach ($images as $singleImage)
                                    ...
                                    <a href="{{url('del-cardboard-image/'.$singleImage.'/'. $edit_prod_item->id)}}">
