    ...
    <div class="">
        ...
        <div class="card-box table-responsive">
            <table id="example1" class="table table-bordered table-striped"  width="100%" cellspacing="0">
                ...
                <tbody>
                    <?php $i = 1; ?>
                    @foreach ($all_states_categories as $singleitem)
                        <tr>
                            <td> <?php  echo $i++ ; ?> </td>
                            <td> <?php echo $singleitem->cate_name;?> </td>
                            <td> <?php echo $singleitem->cate_url;?> </td>
                         
                            <td>
                                <a  data-toggle="tooltip" data-placement="bottom" title="Edit" href="{{ url('edit-states-category'). '/'.$singleitem->id }}" class="text-decoration-none">
                                    <button class="btn btn-submit-view btn-crud edit_btn btn-warning  px-sm-2  mx-auto"  data-src="{{ url('edit-states-category'). '/'.$singleitem->id }}"  >
                                         <i class="fa fa-edit"></i>
                                    </button>
                                 </a>
                            </td>
                            <td>
                                <a  data-toggle="tooltip" data-placement="bottom" title="Delete" href="{{ url('delete-states-category'). '/'.$singleitem->id }}" class="text-decoration-none">
                                   <button class="btn btn-submit-view btn-crud delete_btn btn-danger  px-sm-2  mx-auto"  data-src="{{ url('delete-states-category'). '/'.$singleitem->id }}"  >
