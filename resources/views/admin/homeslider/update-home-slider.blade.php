            ...
            <div class="row">
                <div class="col-md-12 mb-sm-4">
                    <div class="form-group material-style">
                        <input id="inputText3" type="text" name="minititle" class="form-control" value="{{ $singleData->mini_title }}" />
                        <label for="inputText3" class="col-form-label"> Mini Title </label>
                    </div>
                </div>
                <div class="col-md-12 mb-sm-4">
                    <div class="form-group material-style">
                        <input id="inputText3" type="text" name="bigtitle" class="form-control" value="{{ $singleData->big_title }}" />
