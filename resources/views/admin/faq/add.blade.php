...
<div class="right_col" role="main">
  ...
  @endif
    ...
    <div class="">
     ...
     <form class="form px-sm-4" method="post" action="{{ url('add-product-faq-data').'/'}}" enctype="multipart/form-data" >
        @csrf
       
        <div class="row">
            <div  class="col-md-12 mb-sm-4">
                <div class="form-group material-style">
                    <input id="inputText1" type="text" name="question" class="form-control" required=" required" />
            ...
            <div  class="col-md-12 mb-sm-4">
                <div class="form-group material-style">
                    <textarea class="form-control" id="editor1" required="required" name="answer"></textarea>
                ...
                <div class="form-group material-style">
                    <select class="form-control" id="parentcate" name="printing_product_name">
                        ...
                        @foreach($printing_product as $all_printing_product)
                           <option value="{{$all_printing_product->id}}" > {{$all_printing_product->prod_name}} </option>
                        @endforeach
                    </select>
                ...
                <div class="form-group material-style">
                    <select class="form-control" id="parentcate" name="product_name">
                        ...
                        @foreach($product as $all_product)
                           <option value="{{$all_product->id}}" > {{$all_product->prod_name}} </option>
                        @endforeach
                    </select>
                ...
                <div class="form-group material-style">
                    <select class="form-control" id="parentcate" name="category_name">
                        ...
                        @foreach($category as $all_category)
                           <option value="{{$all_category->id}}" > {{$all_category->cate_name}} </option>
                        @endforeach
                    </select>
