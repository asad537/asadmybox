...
<html lang="en">
  ...
  <head>
    ...
    {{-- {{ asset('public/adminassets/vendors/vendors/bootstrap/dist/css/bootstrap.min.css') }} --}}
    <!-- Font Awesome -->
