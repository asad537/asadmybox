@include('frontend/header')
   ...
   <main>
                    ...
                    <div class="container">
                        <div class="hero-text-content">
                            ...
                            <p class="hero-subtitle" style="font-size: 18px; color: #4d4b4bff; margin-bottom: 25px; line-height: 1.6;">
                               Stand out from the competitive market with custom boxes for every product, from the retail industry to E-commerce businesses. Get custom packaging built to impress that enhances your shelf visibility.
                            </p>
      ...
      <section class="cp-services-area pb-20 p-relative z-index-1 mt--20 pt-40 " style="content-visibility: auto; contain-intrinsic-size: 1000px;">
...
@foreach($home_categories as $index => $pp)
...
<!--    </p>-->
<!--</div>-->
@foreach($home_other_products as $index => $pp)
  ...
  <option value="No">No</option>
                            ...
                            <!-- <script src="https://www.google.com/recaptcha/enterprise.js" async defer></script> -->
                                ...
                                (function() {
                                    ...
                                    var interactEvents = ['mousemove', 'touchstart', 'scroll', 'keydown', 'click'];
                                    interactEvents.forEach(function(ev) {
                                        window.addEventListener(ev, loadRecaptcha, { once: true, passive: true });
                                    });
...
<section class="cp-services-area pb-20 p-relative z-index-1 mt--20 pt-20 hide-on-mobile">
  ...
  <section class="cp-news-area white-bg pt-10 pb-10 hide-on-mobile">
