...
<ol class="breadcrumb" vocab="" typeof="BreadcrumbList">
	...
	<li property="itemListElement" typeof="ListItem">
		...
		<span property="name" style="color: #00979f;">{{$value[0]->cate_name}}</span> 
            ...
            <div class="container-fluid" style="">
                ...
                <div class="col-xl-9    pr-xl-2 pr-md-3">
                    ...
                    <div class="col-md-9 pl-md-2  pr-xl-0 pr-md-2 ">
                        ...
                        <div class="mb-4">
                        <img src="{{url('images/'.$value[0]->cate_image)}}" alt="cosmetic-boxes-2" class="img-fluid w-100" />
                        </div>
                        <div class="row">
                            
                              @foreach($all_products as $index)
                              
                              <?php
                              
                              foreach ($pro as $index2){?>
                              
                              <?php  $temp = json_decode($index2->state_products); ?>
                            ...
                            <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6 col-12 mb-md-3 mb-3     pr-xl-2 ">
                                ...
                                <div class="boxes-detailed-content" style="background: #2c9fa4;box-shadow: 0 12px 20px 0 rgba(0, 0, 0, 0.08);transition: box-shadow 0.3s ease-in-out;">
                                    <figure class="mb-0 newpic">
                                         <?php $img_name = $index->prod_altname ;  ?>  
                                        ...
                                        <a href="{{url($index->prod_url).'/'}}">
                                            
                                            <img class="prod-items-pic img-fluid" src="{{url('images/'.$index->prod_image)}}" alt="{{$remove_jpg}}"  width="280" height="280"  >
...
<a href="{{url($index->prod_url).'/'}}" style="text-decoration:none;">
                                      <figcaption class="text-image">

                                       <h4 class="product-title t2">{{$index->prod_name}}</h4>
                                    </figcaption>
                                    </a>
