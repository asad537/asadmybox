...
<main>
                  ...
                  <div class="row align-items-center">
                     ...
                     <div class="col-xl-7 col-lg-6 order-md-1">
                        ...
                        <div class="">
                           ...
                           <h2 class="cp-banner-title mb-50"
                              data-wow-delay="1.1s" style="font-size:40px !important;">{{$category_name[0]->cate_name}}</h2>
                           <p class="cp-banner-text mb-20" style="width: 500px;"
                              data-wow-delay="1.4s">{{$category_name[0]->meta_description}}</p>
                              
                              
                                <div class="cp-banner-btn cp-two-btn wow"
                              data-wow-delay="1.7s">
                              <a href="{{url('get-quote').'/'}}" class="cp-border-btn" style="height: 40px !important;
    line-height: 40px !important;background-color:#86C342;color:white !important;">
                           Request Quote
        ...
        <div class="product-area pt-10 pb-10">
            <div class="container">
                <div class="row">
                     
                              
                    <div class="col-xl-12 col-lg-12 order-lg-2">
                        <div class="cp-product-right mb-20"  style="">
    ...
    color: #86C342;"></i>
      ...
      @foreach ($sub_category as $promItem1)
    <div class="col-xl-2 col-lg-4 col-md-6 col-6 grid-item">
        <div class="">
            <div class="" style="background:none !important;">
                <a href="{{ url(str_replace(' ', '-', strtolower($promItem1->cate_url))) . '/' }}" class="">
               
                    <img 
                        style="border-radius:20px; padding: 5px; width:100%;" 
                        src="{{ url('images/' . $promItem1->cate_image) }}" 
                        alt="{{$promItem1->cate_name}}"
                    >
                </a>

                <ul class="product-links">
                    <li>
                        <a href="{{ url(str_replace(' ', '-', strtolower($promItem1->cate_url))) . '/' }}"></a>
                    </li>
                </ul>
            </div>
            ...
            <div class="product-description" style="background-color:white !important;">
                <div style="height: 45px; overflow: hidden; text-align:center;">
                    <h3 class="for-mobilexx" style="font-size:16px !important; line-height:1.3em;">
                       <a href="{{ url(str_replace(' ', '-', strtolower($promItem1->cate_url))) . '/' }}">  {{ \Illuminate\Support\Str::limit($promItem1->cate_name, 55) }}</a>
                    </h3>
                </div>
            </div>
        </div>
...
<select class="form-control" name="cad_sample" data-gtm-form-interact-field-id="2">
  ...
  <option value="No">No</option>
                           ...
                           <div class="cp-quote-btn mb-10" style="    text-align: center;">
                               <div class="cp-input-field">
                                   <div class="g-recaptcha" id="subcategory-quote-recaptcha" data-sitekey="{{ env('RECAPTCHA_SITE_KEY') }}" data-callback="onSubcategoryQuoteCaptchaSuccess"></div>
                                   <div id="subcategory-quote-captcha-error" style="color: #fff; font-size: 14px; font-weight: bold; margin-top: 10px; display: none; padding: 12px; background: #dc3545; border-radius: 5px;">
                        ...
                        <script>
                        var subcategoryQuoteCaptchaCompleted = false;
                        
                        function onSubcategoryQuoteCaptchaSuccess(token) {
                            subcategoryQuoteCaptchaCompleted = true;
                            var errorDiv = document.getElementById('subcategory-quote-captcha-error');
                            if (errorDiv) {
                        ...
                        (function() {
                            function initSubcategoryQuoteFormValidation() {
                                ...
                                forms[0].onsubmit = function(event) {
                                    if (!subcategoryQuoteCaptchaCompleted) {
                                    ...
                                    if (typeof grecaptcha !== 'undefined' && typeof grecaptcha.getResponse === 'function') {
                                        ...
                                        if (!response || response.length === 0) {
                                            ...
                                            subcategoryQuoteCaptchaCompleted = false;
                                            return false;
                                        }
                                    }
                            ...
                            if (document.readyState === 'loading') {
                                document.addEventListener('DOMContentLoaded', initSubcategoryQuoteFormValidation);
                            } else {
                                initSubcategoryQuoteFormValidation();
                            }
                        })();
                        </script>
                     </div>
